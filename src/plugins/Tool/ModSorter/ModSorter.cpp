...
static const char *const *isaac_sort(const char *const *mod_folders, size_t count,
                                     void *user_data) {
  if (!g_provider)
    return nullptr;
...
extern "C" void gmm_register_v2(GmmRegistrationCtxV2 *ctx) {
  ...
  static const char *bundled_masterlist = "groups:\n"
                                          "  - name: framework\n"
                                          "    priority: 0\n"
                                          "  - name: libraries\n"
                                          "    priority: 10\n"
  ...
  info.description = "LOOT-style mod sorter for The Binding of Isaac: Rebirth";
